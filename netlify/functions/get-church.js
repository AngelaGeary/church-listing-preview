  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        // For post-purchase edit mode: pull from linked tables
        ...
        // For pre-purchase marketing mode: pull from direct Churches table field
        marketingName: fields['Billing name'] || null,
